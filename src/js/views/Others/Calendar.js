  ...
  <AdminLayout>
    ...
    >
      <div class="custom-calendar">
        <div ref="calendarRef" class="min-h-screen"></div>
      </div>
    ...
    setup() {
        ...
        const handleAddOrUpdateEvent = () => {
            ...
            if (selectedEvent.value) {
                ...
                const evt = calendarInstance.value.getEventById(selectedEvent.value.id);
                if (evt) {
                    evt.setProp('title', eventTitle.value);
                    evt.setStart(eventStartDate.value);
                    evt.setEnd(eventEndDate.value);
                    evt.setExtendedProp('calendar', eventLevel.value);
                }
            } else {
        ...
        const handleDeleteEvent = () => {
            if (selectedEvent.value && calendarInstance.value) {
                const evt = calendarInstance.value.getEventById(selectedEvent.value.id);
                if (evt) evt.remove();
                closeModal()
            }
        ...
        onMounted(() => {
            if (calendarRef.value && window.FullCalendar) {
